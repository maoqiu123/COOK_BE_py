    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(verbose_name='用户头像', blank=True, null=True, upload_to='')),
                ('token', models.CharField(verbose_name='用户token', max_length=200, blank=True, null=True)),
                ('token_expire', models.DateTimeField(verbose_name='token过期时间', blank=True, null=True, default=datetime.datetime.now)),
